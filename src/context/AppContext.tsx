...
export function AppProvider({ children }: { children: ReactNode }) {
    ...
    const updateUserProgress = useCallback(async (newProgress: any) => {
    ...
    const syncProgressWithCloud = useCallback(async (userId: string) => {
        try {
    ...
    }, [syncProgressWithCloud, fetchSubscriptionStatus]);
